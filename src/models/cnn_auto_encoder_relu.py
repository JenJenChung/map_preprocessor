...
class ModelAErelu(nn.Module):

    def __init__(self, code_size, image_width, image_height):
        super(ModelAErelu, self).__init__()
    ...
    def encode(self, images):
        ...
        code = F.relu(F.max_pool2d(code, self.pool))
    ...
    def decode(self, code):
        ...
        out = F.relu(self.dec_cnn_3(self.upsampling(out)))
        out = F.relu(self.dec_cnn_2(self.upsampling(out)))
